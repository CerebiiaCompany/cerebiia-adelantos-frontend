      ...
      <div className="flex items-center justify-center min-h-[60vh] animate-fade-in">
        <div className="glass-card glow-border p-8 text-center max-w-md">
          ...
          <p className="text-muted-foreground mb-4">
            <span className="text-primary font-bold text-3xl">{formatCOP(total)}</span><br />
          ...
          <div className="glass-card p-4 mb-6 text-left space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-foreground font-medium">{formatCOP(amount)}</span>
            </div>
            <div className="flex justify-between text-sm">
    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="glass-card glow-border p-6">
        <div className="text-center mb-6">
          ...
          <p className="text-5xl font-display font-bold text-gradient">{formatCOP(amount)}</p>
          <p className="text-xs text-muted-foreground mt-2">Disponible: {formatCOP(maxAmount)}</p>
        </div>
        ...
        <div className="glass-card p-4 space-y-3">
          ...
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">Monto solicitado</span>
            <span className="text-foreground">{formatCOP(amount)}</span>
          </div>
          <div className="flex justify-between text-sm">
